...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/file-tree-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12371&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/file-tree-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `file-tree` can be installed with:

```
conda install file-tree
```

It is possible to list all of the versions of `file-tree` available on your platform with:
